# Decompile by Alex (Tools By Alex)
# Time Succes decompile : 2022-04-09 16:59:50.150900
...
print("\033[0;92mThis Tool's Free By Alex")
...
def menu():
    ...
    print'FB OLD ID CLONING-[Alex Prince]'

    print 50* '-'

    print '\033[0;92mCodder   : Sehar Khan'

    print '\033[0;91mAUTHOR   : Hittler Family'

    print '\033[0;93mINSTAGRAM : Farhadali0072'

    print '\033[0;96mOWNERS   : AHMER WAHEED SALAR ANAS SHANI'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[HITTLER-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Hittler-CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\x1b[0m \n'
